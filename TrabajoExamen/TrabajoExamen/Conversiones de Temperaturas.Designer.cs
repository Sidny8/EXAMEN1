...
namespace TrabajoExamen
{
	partial class Conversiones_de_Temperaturas
	{
		...
		private void InitializeComponent()
		{
			...
			this.rdbCaK.UseVisualStyleBackColor = true;
			...
			this.rdbFaC.UseVisualStyleBackColor = true;
			...
			this.rdbKaF.UseVisualStyleBackColor = true;
			...
			this.rdbKaC.UseVisualStyleBackColor = true;
			...
			this.rdbCaF.UseVisualStyleBackColor = true;
			...
			this.rdbFaK.UseVisualStyleBackColor = true;
