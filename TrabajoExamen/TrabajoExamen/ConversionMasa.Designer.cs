...
namespace TrabajoExamen
{
	partial class ConversionMasa
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "CONVERSIONES DE MASA";
			// 
			// label2
			// 
			...
			this.label4.Text = "Valor a Calcular:";
			// 
			// label5
			// 
			...
			this.cmbde.Items.AddRange(new object[] {
									...
									"Gramos",
									"Toneladas"});
			this.cmbde.Location = new System.Drawing.Point(12, 84);
			this.cmbde.Name = "cmbde";
			this.cmbde.Size = new System.Drawing.Size(121, 24);
			this.cmbde.TabIndex = 11;
			// 
			// cmba
			// 
			...
			this.cmba.Items.AddRange(new object[] {
									...
									"Gramos",
									"Toneladas"});
			this.cmba.Location = new System.Drawing.Point(161, 84);
			this.cmba.Name = "cmba";
			...
			this.lblresultado.Location = new System.Drawing.Point(161, 170);
			...
			this.btnconvertir.Location = new System.Drawing.Point(23, 216);
			this.btnconvertir.Name = "btnconvertir";
			this.btnconvertir.Size = new System.Drawing.Size(100, 37);
			...
			this.btnsalir.Location = new System.Drawing.Point(177, 216);
